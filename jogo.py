...
def handle_move(data):
    ...
    # Verifica se a célula está vazia e se é a vez do jogador correto
    if board[index] == '' and data['symbol'] == current_turn:
        ...
        if check_winner(current_turn):
            ...
            emit('update_turn', {'turn': current_turn}, broadcast=True)
